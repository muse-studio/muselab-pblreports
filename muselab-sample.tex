...
\documentclass[submit,techrep,noauthor]{muselab}
...
\author{320450xx　福知山 花子}{Joho Taro}{FUKU}[joho.taro@fukuchiyama.ac.jp]
...
いる．
\begin{enumerate}
\item \|muselab.cls      |: 最終原稿用スタイルファイル
...
\bibliography{bibsample} % .bibファイルの名前（Zoteroからエクスポートして作る）
